...
cd directory-traversal/butler-server
...
# start the server
echo -e "\t[${GREEN}start vulnerable server${NC}]: ${BLUE}butler-server${NC}"
$NODE ../../node_modules/butler-server/bin/butler >/dev/null 2>&1  &
vulnpid=$!
