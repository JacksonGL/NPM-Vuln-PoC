...
cd directory-traversal/simple-mock-server
...
# start the server
echo -e "\t[${GREEN}start vulnerable server${NC}]: ${BLUE}simple-mock-server${NC}"
$NODE ../../node_modules/simple-mock-server/bin/simple-mock-server >/dev/null 2>&1  &
vulnpid=$!
