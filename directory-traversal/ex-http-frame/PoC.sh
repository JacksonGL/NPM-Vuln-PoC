...
cd directory-traversal/ex-http-frame
...
# start the server
echo -e "\t[${GREEN}start vulnerable server${NC}]: ${BLUE}ex-http-frame${NC}"
$NODE ../../node_modules/ex-http-frame/index.js >/dev/null 2>&1  &
vulnpid=$!
