...
# remove incompatible mime package
rm -rf node_modules/mime_web_server/node_modules/mime

cd directory-traversal/mime_web_server
...
# start the server
echo -e "\t[${GREEN}start vulnerable server${NC}]: ${BLUE}mime_web_server${NC}"
