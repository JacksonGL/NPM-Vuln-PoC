...
echo -e "\t[i]: Use node v5 or earlier to exploit this vulnerability"
...
cd directory-traversal/less-livereload
...
# start the server
echo -e "\t[${GREEN}start vulnerable server${NC}]: ${BLUE}less-livereload${NC}"
