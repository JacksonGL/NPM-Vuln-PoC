...
cd directory-traversal/webkit-devtools-agent-frontend
...
# start the server
echo -e "\t[${GREEN}start vulnerable server${NC}]: ${BLUE}webkit-devtools-agent-frontend${NC}"
$NODE ../../node_modules/webkit-devtools-agent-frontend/server.js >/dev/null 2>&1  &
vulnpid=$!
