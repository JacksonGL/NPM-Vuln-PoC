...
cd directory-traversal/grunt-fileserver
...
# start the server
echo -e "\t[${GREEN}start vulnerable server${NC}]: ${BLUE}grunt-fileserver${NC}"
$NODE ../../node_modules/grunt/bin/grunt fileserver >/dev/null 2>&1  &
vulnpid=$!
