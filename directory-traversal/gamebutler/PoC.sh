...
cd directory-traversal/gamebutler
...
# start the server
echo -e "\t[${GREEN}start vulnerable server${NC}]: ${BLUE}gamebutler${NC}"
$NODE ../../node_modules/gamebutler/build/gamebutler.js ../../node_modules/gamebutler/index.html >/dev/null 2>&1  &
vulnpid=$!
